%%------------------       Description ---------------------------------%
%  This program reproduces Fig. 4 in [1].
%  The script ilustrates the convergence of the Manifold Optimization
...
%% ============== Scenario (parameters) ================
M = 40;            % number of BD-RIS elements
...
for nn = 1:numsimul   % loop for simulations (MO runs starting from different initialization points)
    ...
    plot(10*log10(ILBDRISconv/ILwoRIS),'r');
